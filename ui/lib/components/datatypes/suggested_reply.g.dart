// This generated file is used by `nook_suggested_reply.dart`
// and should not be imported or exported by any other file.
//
//   Source File  : nook_suggested_reply.dart
//   Source SHA   : 7113a2626d88acd1b15464ddf47df3235bca781a9b582971a3f2616ce26cf08e
//   Generated by : danrubel
//
// Use "kktool codegen nook_suggested_reply.dart" to regenerate this file.
...
class SuggestedReply {
  ...
  static SuggestedReply fromData(data, [SuggestedReply modelObj]) {
    ...
    return (modelObj ?? SuggestedReply())
      ...
      ..seq_no = int_fromData(log, 'seq_no', data)
      ..category = data['category']?.toString()
      ..group_id = data['group_id']?.toString()
      ..group_description = data['group_description']?.toString()
      ..index_in_group = int_fromData(log, 'index_in_group', data)
      ..additionalInfo = Map_fromData<dynamic>(log, 'additionalInfo', data);
  }

  static StreamSubscription listen(DocStorage docStorage, SuggestedReplyCollectionListener listener,
          {String collectionRoot = '/$collectionName', OnErrorListener onError}) =>
      listenForUpdates<SuggestedReply>(log, docStorage, listener, collectionRoot, SuggestedReply.fromSnapshot, onError: onError);
...
final log = Logger('suggested_reply.g.dart');

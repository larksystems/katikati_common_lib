// This generated file is used by `nook_user.dart`
// and should not be imported or exported by any other file.
//
//   Source File  : nook_user.dart
//   Source SHA   : 7ffb80e1e1dab2154e1a358dd51aff4ce47ca224417169d99aa920a1a89c6abd
//   Generated by : danrubel
//
// Use "kktool codegen nook_user.dart" to regenerate this file.
...
class UserConfiguration {
  ...
  static StreamSubscription listen(DocStorage docStorage, UserConfigurationCollectionListener listener,
      ...
      listenForUpdates<UserConfiguration>(_log, docStorage, listener, collectionRoot, UserConfiguration.fromSnapshot, onError: onError);
...
class UserPresence {
  ...
  static StreamSubscription listen(DocStorage docStorage, UserPresenceCollectionListener listener,
          {String collectionRoot = '/$collectionName', OnErrorListener onError}) =>
      listenForUpdates<UserPresence>(_log, docStorage, listener, collectionRoot, UserPresence.fromSnapshot, onError: onError);

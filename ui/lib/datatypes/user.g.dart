...
//   Source SHA   : 60c2f57611d81a1438986c551f410e27eb332bf724cea7334b279d33032c171a
...
class UserConfiguration {
  ...
  String get defaultSelectedPanel => default_selected_panel;
  ...
  set defaultSelectedPanel(String value) => default_selected_panel = value;
  ...
  static UserConfiguration fromData(data, [UserConfiguration modelObj]) {
    ...
    (modelObj ??= UserConfiguration())
      ..role = Role.fromData(_log, 'role', data)
      ...
      ..default_selected_panel = data['default_selected_panel']?.toString()
  ...
  Map<String, dynamic> toData({bool validate: true}) {
    return {
      ...
      if (default_selected_panel != null) 'default_selected_panel': default_selected_panel,
...
class Role {
  ...
  static const projectAdmin = Role('projectAdmin');
  static const superAdmin = Role('superAdmin');
  ...
  static Role fromData(Logger log, String key, dynamic data) {
    if (data == null) return null;
    var value = data[key];
    if (value == null) return null;
    if (value is Role) return value;
    if (value is String) {
      const prefix = 'Role.';
      ...
      log.warning('Unknown Role $value at "$key" in $data');
      return user;
    }
    log.warning('Expected Role at "$key", but found "$value" in $data');
    return user;
  }
  ...
  String toData({bool validate}) => 'Role.$name';

...
//   Source SHA   : eee3cb1d95057d40907f04f85413e5085e9ba8be6af3942d23a8028163f39958
...
class UserConfiguration {
  ...
  bool deanonymised_conversations_enabled;
  ...
  bool get deanonymisedConversationsEnabled => deanonymised_conversations_enabled;
  ...
  set deanonymisedConversationsEnabled(bool value) => deanonymised_conversations_enabled = value;
  ...
  static UserConfiguration fromData(data, [UserConfiguration modelObj]) {
    ...
    (modelObj ??= UserConfiguration())
      ...
      ..deanonymised_conversations_enabled = bool_fromData(_log, 'deanonymised_conversations_enabled', data)
  ...
  Map<String, dynamic> toData({bool validate: true}) {
    return {
      ...
      if (deanonymised_conversations_enabled != null) 'deanonymised_conversations_enabled': deanonymised_conversations_enabled,
